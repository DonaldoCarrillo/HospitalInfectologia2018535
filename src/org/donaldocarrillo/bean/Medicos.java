...
private String sexo;
    ...
    public Medicos(int codigoMedico, int licenciaMedica, String nombres, String apellidos, String horaEntrada, String horaSalida, int turnoMaximo, String sexo) {
    ...
    public String toString(){
        return  getCodigoMedico() + "|" + getNombres();
    }
}
